...
public class MessagingConfiguration {
	 ...
	 * @Bean
	 * 
	 * @InboundChannelAdapter(value = Source.OUTPUT, poller = @Poller(fixedRate =
	 * "60000")) public MessageSource<String> timerMessageSource() { return () ->
	 * new GenericMessage<>("Test message from " + applicationName + " sent at " +
