...
/**
 * Integration tests for the {@link RefoundDetailsResource} REST controller.
 */
@SpringBootTest(classes = {AdministrationApp.class, TestSecurityConfiguration.class})
public class RefoundDetailsResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static RefoundDetails createUpdatedEntity(EntityManager em) {
        RefoundDetails refoundDetails = new RefoundDetails()
